...
import 'package:FunnyShorts/src/presentation/bloc/joke_bloc.dart';
import 'package:FunnyShorts/src/presentation/screens/joke_screen.dart';
import 'package:FunnyShorts/src/presentation/widgets/joke_list_widget.dart';
import 'package:FunnyShorts/src/presentation/widgets/joke_view.dart';
...
void main() {
  ...
  group('App', () {
    ...
    testWidgets('Find Widgets', (tester) async {
      ...
      expect(find.text('Funny Shorts'), findsOneWidget);
      expect(find.byType(JokeListWidget), findsOneWidget);
